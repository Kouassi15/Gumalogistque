<div class="right-sidebar">
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				<img src="{{asset('templatedash/vendors/images/deskapp-logo.svg')}}" alt="" class="dark-logo">
				<img src="{{asset('templatedash/vendors/images/deskapp-logo-white.svg')}}" alt="" class="light-logo">
			</a>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="{{ route('dashboard.services') }}">Ajouter</a></li>
							<li><a href="{{ route('dashboard.liste') }}">Liste des services</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li><a href="{{ route('dashboard.projects') }}">Ajouter</a></li>
							<li><a href="{{ route('dashboard.listeprojects') }}">Liste des projets</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext">Materiels </span>
						</a>
						<ul class="submenu">
